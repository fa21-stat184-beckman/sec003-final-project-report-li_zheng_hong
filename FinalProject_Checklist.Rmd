...
(A) .Rmd Line numbers where at least two different data sources are imported:  41， 45

(B) .Rmd Line numbers for inspecting data intake:  54-67， 75-90

### Data Wrangling / Cleaning / ect (5 out of 7 required)


(A) .Rmd Line number(s) for general data wrangling: 120-122， 133-135， 142-144， 154 -157

(B) .Rmd Line number(s) for a join operation: 290-293

(C) .Rmd Line number(s) for a pivot_wider or pivot_longer operation (or equivalent): none

(D) .Rmd Line number(s) for use of regular expressions: 181

(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 353， 282， 157

(F) .Rmd Line number(s) for use of user-defined functions: 312-327

(G) .Rmd Line number(s) for use of loops and/or control flow: 312-327
...
(A) .Rmd Line numbers for use of multiple different geoms:  366， 388， 244

(B) .Rmd Line number(s) for use of multiple aesthetics:  243， 366， 388

(C) .Rmd Line number(s) for use of layered graphics:  none

(D) .Rmd Line number(s) for use of leaflet or choropleth maps:  419-424， 431-433

(E) .Rmd Line number(s) for use of decision tree or dendogram results: none
